...
export class CountriesDataService {
  ...
  constructor() {  
    this.countriesData = {
      ...
      "Ghana": [7.9465, -1.0232],
      "Gibraltar": [36.1377, -5.3453],
      "Greece": [39.0742, 21.8243],
      "Greenland": [71.7069, -42.6043],
      "Grenada": [12.1165, -61.6789],
      ...
      "Virgin Islands (British)": [18.4207, -64.6399],
      "Virgin Islands (U.S.)": [18.3358, -64.8963],
  ...
  getCountryData(country: string): any | undefined {
    if (this.countriesData.hasOwnProperty(country)) {
      return this.countriesData[country];
    }
    return undefined;
  }
